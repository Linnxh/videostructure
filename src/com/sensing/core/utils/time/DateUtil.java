 ...
 * 
 * <p>Title: DateUtil</p>
 * <p>Description: 日期格式化类 </p>
 * <p>Company: www.sensingtech.com</p> 
 * @author	haowenfeng
 * @date	2017年8月9日上午11:37:37
 * @version 1.0
 */
...
public class DateUtil {
	 ...
	 * 获取当前日期是星期几 
	 * @param date 修要判断的时间
	 * @return 结果，例如星期一，返回结果为1
	 * @throws Exception
	 * @author mingxingyu
	 * @date   2017年8月10日上午9:49:05
	 */
     ...
     * @return
     */
    public static Date removeHMS(Date req) {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        String s = sdf.format(req);
        Date date = null;
        try {
            date = sdf.parse(s);
