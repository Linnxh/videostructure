...
public class Regions implements Serializable {
    ...
    public String toString() {
        return "Regions [id=" + id + ", rId=" + rId + ", regionName="
                + regionName + ", regionDescription=" + regionDescription
                + ", parentId=" + parentId + ", regionLevel=" + regionLevel
                + ", regionSort=" + regionSort + ", searchCode=" + searchCode
                + ", nodeType=" + nodeType + ", state=" + state + "]";
    }
