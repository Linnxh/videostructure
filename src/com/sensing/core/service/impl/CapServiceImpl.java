...
import com.sensing.core.thrifts.cap.bean.CapMotorResult;
import com.sensing.core.thrifts.cap.bean.CapNonmotorResult;
import com.sensing.core.thrifts.cap.bean.CapPeopleResult;
import com.sensing.core.thrifts.cap.service.VideoStructure.Client;
...
public class CapServiceImpl implements ICapService {
	...
	public Map<String, Object> queryCap(byte[] imgBytes) throws Exception {
		...
		// 开启抓拍
		TTransport transport = new TSocket(RemoteInfoUtil.CAP_SERVER_IP,RemoteInfoUtil.CAP_IMGINFO_PORT,
	...
	public FeatureInfo getFeaByImgBytes(byte[] imageBytes) throws Exception {
		...
		TProtocol protocol = new TBinaryProtocol(transport);
		client = new com.sensing.core.thrift.cap.service.CaptureService.Client(protocol);;
		try {
