...
public class FaceDetectInfo implements org.apache.thrift.TBase<FaceDetectInfo, FaceDetectInfo._Fields>, java.io.Serializable, Cloneable, Comparable<FaceDetectInfo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("FaceDetectInfo");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new FaceDetectInfoStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new FaceDetectInfoTupleSchemeFactory();

  public _RECT rcFace; // required
  public _POINT ptLeftEye; // required
  public _POINT ptRightEye; // required
  public _POINT ptMouth; // required
  public _POINT ptNose; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.RC_FACE, new org.apache.thrift.meta_data.FieldMetaData("rcFace", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, _RECT.class)));
    tmpMap.put(_Fields.PT_LEFT_EYE, new org.apache.thrift.meta_data.FieldMetaData("ptLeftEye", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, _POINT.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(FaceDetectInfo.class, metaDataMap);
  }
   ...
   */
  public FaceDetectInfo(FaceDetectInfo other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetRcFace()) {
      this.rcFace = new _RECT(other.rcFace);
    }
    if (other.isSetPtLeftEye()) {
      this.ptLeftEye = new _POINT(other.ptLeftEye);
    }
    if (other.isSetPtRightEye()) {
      this.ptRightEye = new _POINT(other.ptRightEye);
    }
    if (other.isSetPtMouth()) {
      this.ptMouth = new _POINT(other.ptMouth);
    }
    if (other.isSetPtNose()) {
      this.ptNose = new _POINT(other.ptNose);
    }
  ...
  public FaceDetectInfo deepCopy() {
    return new FaceDetectInfo(this);
  }
  ...
  public _RECT getRcFace() {
    return this.rcFace;
  }

  public FaceDetectInfo setRcFace(_RECT rcFace) {
    this.rcFace = rcFace;
    return this;
  }
  ...
  public _POINT getPtLeftEye() {
    return this.ptLeftEye;
  }

  public FaceDetectInfo setPtLeftEye(_POINT ptLeftEye) {
    this.ptLeftEye = ptLeftEye;
    return this;
  }
  ...
  public _POINT getPtRightEye() {
    return this.ptRightEye;
  }

  public FaceDetectInfo setPtRightEye(_POINT ptRightEye) {
    this.ptRightEye = ptRightEye;
    return this;
  }
  ...
  public _POINT getPtMouth() {
    return this.ptMouth;
  }

  public FaceDetectInfo setPtMouth(_POINT ptMouth) {
    this.ptMouth = ptMouth;
    return this;
  }
  ...
  public _POINT getPtNose() {
    return this.ptNose;
  }

  public FaceDetectInfo setPtNose(_POINT ptNose) {
    this.ptNose = ptNose;
    return this;
  }
  ...
  public FaceDetectInfo setIYaw(int iYaw) {
    this.iYaw = iYaw;
    setIYawIsSet(true);
    return this;
  }
  ...
  public FaceDetectInfo setIPitch(int iPitch) {
    this.iPitch = iPitch;
    setIPitchIsSet(true);
    return this;
  }
  ...
  public FaceDetectInfo setIRoll(int iRoll) {
    this.iRoll = iRoll;
    setIRollIsSet(true);
    return this;
  }
  ...
  public FaceDetectInfo setIQuality(int iQuality) {
    this.iQuality = iQuality;
    setIQualityIsSet(true);
    return this;
  }
  ...
  public FaceDetectInfo setIGender(int iGender) {
    this.iGender = iGender;
    setIGenderIsSet(true);
    return this;
  }
  ...
  public FaceDetectInfo setIAge(int iAge) {
    this.iAge = iAge;
    setIAgeIsSet(true);
    return this;
  }
  ...
  public FaceDetectInfo setStrSdkVer(java.lang.String strSdkVer) {
    this.strSdkVer = strSdkVer;
    return this;
  }
  ...
  public FaceDetectInfo setBinFea(byte[] binFea) {
    this.binFea = binFea == null ? (java.nio.ByteBuffer)null : java.nio.ByteBuffer.wrap(binFea.clone());
    return this;
  }

  public FaceDetectInfo setBinFea(java.nio.ByteBuffer binFea) {
    this.binFea = org.apache.thrift.TBaseHelper.copyBinary(binFea);
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof FaceDetectInfo)
      return this.equals((FaceDetectInfo)that);
    return false;
  }

  public boolean equals(FaceDetectInfo that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(FaceDetectInfo other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("FaceDetectInfo(");
    boolean first = true;
  ...
  private static class FaceDetectInfoStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public FaceDetectInfoStandardScheme getScheme() {
      return new FaceDetectInfoStandardScheme();
    }
  }

  private static class FaceDetectInfoStandardScheme extends org.apache.thrift.scheme.StandardScheme<FaceDetectInfo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, FaceDetectInfo struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FaceDetectInfo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class FaceDetectInfoTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public FaceDetectInfoTupleScheme getScheme() {
      return new FaceDetectInfoTupleScheme();
    }
  }

  private static class FaceDetectInfoTupleScheme extends org.apache.thrift.scheme.TupleScheme<FaceDetectInfo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, FaceDetectInfo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, FaceDetectInfo struct) throws org.apache.thrift.TException {
