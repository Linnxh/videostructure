...
public class _capFaceDetectResult implements org.apache.thrift.TBase<_capFaceDetectResult, _capFaceDetectResult._Fields>, java.io.Serializable, Cloneable, Comparable<_capFaceDetectResult> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("_capFaceDetectResult");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new _capFaceDetectResultStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new _capFaceDetectResultTupleSchemeFactory();

  public _capRECT rcFace; // required
  public _capPOINT ptLeftEye; // required
  public _capPOINT ptRightEye; // required
  public _capPOINT ptMouth; // required
  public _capPOINT ptNose; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.RC_FACE, new org.apache.thrift.meta_data.FieldMetaData("rcFace", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, _capRECT.class)));
    tmpMap.put(_Fields.PT_LEFT_EYE, new org.apache.thrift.meta_data.FieldMetaData("ptLeftEye", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, _capPOINT.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(_capFaceDetectResult.class, metaDataMap);
  }

  public _capFaceDetectResult() {
  }

  public _capFaceDetectResult(
    _capRECT rcFace,
    _capPOINT ptLeftEye,
    _capPOINT ptRightEye,
    _capPOINT ptMouth,
    _capPOINT ptNose,
    int iYaw,
    int iPitch,
   ...
   */
  public _capFaceDetectResult(_capFaceDetectResult other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetRcFace()) {
      this.rcFace = new _capRECT(other.rcFace);
    }
    if (other.isSetPtLeftEye()) {
      this.ptLeftEye = new _capPOINT(other.ptLeftEye);
    }
    if (other.isSetPtRightEye()) {
      this.ptRightEye = new _capPOINT(other.ptRightEye);
    }
    if (other.isSetPtMouth()) {
      this.ptMouth = new _capPOINT(other.ptMouth);
    }
    if (other.isSetPtNose()) {
      this.ptNose = new _capPOINT(other.ptNose);
    }
  ...
  public _capFaceDetectResult deepCopy() {
    return new _capFaceDetectResult(this);
  }
  ...
  public _capRECT getRcFace() {
    return this.rcFace;
  }

  public _capFaceDetectResult setRcFace(_capRECT rcFace) {
    this.rcFace = rcFace;
    return this;
  }
  ...
  public _capPOINT getPtLeftEye() {
    return this.ptLeftEye;
  }

  public _capFaceDetectResult setPtLeftEye(_capPOINT ptLeftEye) {
    this.ptLeftEye = ptLeftEye;
    return this;
  }
  ...
  public _capPOINT getPtRightEye() {
    return this.ptRightEye;
  }

  public _capFaceDetectResult setPtRightEye(_capPOINT ptRightEye) {
    this.ptRightEye = ptRightEye;
    return this;
  }
  ...
  public _capPOINT getPtMouth() {
    return this.ptMouth;
  }

  public _capFaceDetectResult setPtMouth(_capPOINT ptMouth) {
    this.ptMouth = ptMouth;
    return this;
  }
  ...
  public _capPOINT getPtNose() {
    return this.ptNose;
  }

  public _capFaceDetectResult setPtNose(_capPOINT ptNose) {
    this.ptNose = ptNose;
    return this;
  }
  ...
  public _capFaceDetectResult setIYaw(int iYaw) {
    this.iYaw = iYaw;
    setIYawIsSet(true);
    return this;
  }
  ...
  public _capFaceDetectResult setIPitch(int iPitch) {
    this.iPitch = iPitch;
    setIPitchIsSet(true);
    return this;
  }
  ...
  public _capFaceDetectResult setIRoll(int iRoll) {
    this.iRoll = iRoll;
    setIRollIsSet(true);
    return this;
  }
  ...
  public _capFaceDetectResult setIQuality(int iQuality) {
    this.iQuality = iQuality;
    setIQualityIsSet(true);
    return this;
  }
  ...
  public _capFaceDetectResult setIGender(int iGender) {
    this.iGender = iGender;
    setIGenderIsSet(true);
    return this;
  }
  ...
  public _capFaceDetectResult setIAge(int iAge) {
    this.iAge = iAge;
    setIAgeIsSet(true);
    return this;
  }
  ...
  public _capFaceDetectResult setStrSdkVer(java.lang.String strSdkVer) {
    this.strSdkVer = strSdkVer;
    return this;
  }
  ...
  public _capFaceDetectResult setBinFea(byte[] binFea) {
    this.binFea = binFea == null ? (java.nio.ByteBuffer)null : java.nio.ByteBuffer.wrap(binFea.clone());
    return this;
  }

  public _capFaceDetectResult setBinFea(java.nio.ByteBuffer binFea) {
    this.binFea = org.apache.thrift.TBaseHelper.copyBinary(binFea);
    return this;
  }
  ...
  public _capFaceDetectResult setBinImg(byte[] binImg) {
    this.binImg = binImg == null ? (java.nio.ByteBuffer)null : java.nio.ByteBuffer.wrap(binImg.clone());
    return this;
  }

  public _capFaceDetectResult setBinImg(java.nio.ByteBuffer binImg) {
    this.binImg = org.apache.thrift.TBaseHelper.copyBinary(binImg);
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof _capFaceDetectResult)
      return this.equals((_capFaceDetectResult)that);
    return false;
  }

  public boolean equals(_capFaceDetectResult that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(_capFaceDetectResult other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("_capFaceDetectResult(");
    boolean first = true;
  ...
  private static class _capFaceDetectResultStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public _capFaceDetectResultStandardScheme getScheme() {
      return new _capFaceDetectResultStandardScheme();
    }
  }

  private static class _capFaceDetectResultStandardScheme extends org.apache.thrift.scheme.StandardScheme<_capFaceDetectResult> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, _capFaceDetectResult struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 2: // PT_LEFT_EYE
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.ptLeftEye = new _capPOINT();
          ...
          case 3: // PT_RIGHT_EYE
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.ptRightEye = new _capPOINT();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, _capFaceDetectResult struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class _capFaceDetectResultTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public _capFaceDetectResultTupleScheme getScheme() {
      return new _capFaceDetectResultTupleScheme();
    }
  }

  private static class _capFaceDetectResultTupleScheme extends org.apache.thrift.scheme.TupleScheme<_capFaceDetectResult> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, _capFaceDetectResult struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, _capFaceDetectResult struct) throws org.apache.thrift.TException {
