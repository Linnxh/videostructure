package com.sensing.core.thrifts.cap.bean;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.lstPeople = new java.util.ArrayList<CapPeopleResult>(_list0.size);
                CapPeopleResult _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = new CapPeopleResult();
                  _elem1.read(iprot);
                  struct.lstPeople.add(_elem1);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.lstMotors = new java.util.ArrayList<CapMotorResult>(_list3.size);
                CapMotorResult _elem4;
                for (int _i5 = 0; _i5 < _list3.size; ++_i5)
                {
                  _elem4 = new CapMotorResult();
                  _elem4.read(iprot);
                  struct.lstMotors.add(_elem4);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.lstNonmotors = new java.util.ArrayList<CapNonmotorResult>(_list6.size);
                CapNonmotorResult _elem7;
                for (int _i8 = 0; _i8 < _list6.size; ++_i8)
                {
                  _elem7 = new CapNonmotorResult();
                  _elem7.read(iprot);
                  struct.lstNonmotors.add(_elem7);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CapFeaturesSet struct) throws org.apache.thrift.TException {
      ...
      if (struct.lstPeople != null) {
        oprot.writeFieldBegin(LST_PEOPLE_FIELD_DESC);
        {
          ...
          for (CapPeopleResult _iter9 : struct.lstPeople)
          {
            _iter9.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.lstMotors != null) {
        oprot.writeFieldBegin(LST_MOTORS_FIELD_DESC);
        {
          ...
          for (CapMotorResult _iter10 : struct.lstMotors)
          {
            _iter10.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.lstNonmotors != null) {
        oprot.writeFieldBegin(LST_NONMOTORS_FIELD_DESC);
        {
          ...
          for (CapNonmotorResult _iter11 : struct.lstNonmotors)
          {
            _iter11.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetLstPeople()) {
        {
          ...
          for (CapPeopleResult _iter12 : struct.lstPeople)
          {
            _iter12.write(oprot);
          }
        }
      ...
      if (struct.isSetLstMotors()) {
        {
          ...
          for (CapMotorResult _iter13 : struct.lstMotors)
          {
            _iter13.write(oprot);
          }
        }
      ...
      if (struct.isSetLstNonmotors()) {
        {
          ...
          for (CapNonmotorResult _iter14 : struct.lstNonmotors)
          {
            _iter14.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.lstPeople = new java.util.ArrayList<CapPeopleResult>(_list15.size);
          CapPeopleResult _elem16;
          for (int _i17 = 0; _i17 < _list15.size; ++_i17)
          {
            _elem16 = new CapPeopleResult();
            _elem16.read(iprot);
            struct.lstPeople.add(_elem16);
          }
        }
        struct.setLstPeopleIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.lstMotors = new java.util.ArrayList<CapMotorResult>(_list18.size);
          CapMotorResult _elem19;
          for (int _i20 = 0; _i20 < _list18.size; ++_i20)
          {
            _elem19 = new CapMotorResult();
            _elem19.read(iprot);
            struct.lstMotors.add(_elem19);
          }
        }
        struct.setLstMotorsIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.lstNonmotors = new java.util.ArrayList<CapNonmotorResult>(_list21.size);
          CapNonmotorResult _elem22;
          for (int _i23 = 0; _i23 < _list21.size; ++_i23)
          {
            _elem22 = new CapNonmotorResult();
            _elem22.read(iprot);
            struct.lstNonmotors.add(_elem22);
          }
        }
        struct.setLstNonmotorsIsSet(true);
      }
