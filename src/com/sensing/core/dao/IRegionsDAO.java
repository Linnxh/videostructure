...
public interface IRegionsDAO {
	...
	/**
	 * 查询某一级中最大的search_code
	 * author dongsl
	 * date 2017年8月10日下午8:18:05
	 */
	 ...
	 * 根据父id和区域名称查询区域（区域去重）
	 * author dongsl
	 * date 2017年8月21日下午8:37:32
	 */
	public List<Regions> queryRegionByParentId(@Param("parentId")String parentId,@Param("regionName") String regionName,@Param("id")Integer id) throws Exception;
	...
	public Regions queryMaxSortByParentId(@Param("parentId")Integer parentId,@Param("id")Integer id) throws Exception;
	 ...
	 */
	public List<Regions> queryChildsById(@Param("regionId")Integer regionId,@Param("isDeleted")String isDeleted) throws Exception;
