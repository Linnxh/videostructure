...
public interface ISysUserDAO {
    ...
    public List<SysUser> queryUserByRoleId(Pager pager) throws Exception;

    public List<SysUser> queryUser(Pager pager) throws Exception;

    public int queryCountByRoleId(Pager pager) throws Exception;
    ...
    public List<SysUser> getUserHaveRatify(Integer id);
}
