...
public class SessionController extends BaseController {
	...
	@ResponseBody
	@RequestMapping("/test")
	public ResponseBean test(@RequestBody JSONObject params) {
		log.info("session/test请求的参数为:"+params.toString());
		
//		String minute = params.getString("minute");
//		if ( StringUtils.isEmptyOrNull(minute) ) {
//			request.getSession().setMaxInactiveInterval( Integer.parseInt(minute) * 60 );
//		}
